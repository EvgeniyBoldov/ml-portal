...
_EXAMPLES: Dict[SystemLLMRoleType, ExamplesV2] = {
    SystemLLMRoleType.PLANNER: {"input": {"goal": "Найти источник данных", "available_agents": [{"slug": "viewer"}]}, "outputs": {"apply_graph": {"action": "apply_graph", "tasks": [{"task_id": "discover", "executor": "viewer", "intent": "discover", "instructions": "Собрать источники"}]}}},

...
def _planner_examples() -> ExamplesV2:
    return {
        ...
        "outputs": {
            "create": {"decision": "create_plan", "expected_revision": 0, "rationale": "Нужен один discovery task.", "tasks": [{"task_id": "discover", "title": "Собрать источники", "objective": "Собрать доступные источники", "agent_slug": "viewer"}]},

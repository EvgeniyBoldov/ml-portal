...
SEED_AGENTS = [
    {
        ...
        "version": {
            ...
            "rules": (
                ...
                "4. После успешного поиска можешь вызвать project_memory.mark только для атомарных ценных сведений, указав evidence_call_id из результата инструмента.\n"
            ...
            "tool_use_rules": (
                ...
                "project_memory.mark вызывай только после успешного поиска и передавай evidence_call_ids, содержащий evidence_call_id из результата поиска; artifact_id и native tool-call ID не подходят."
            ),

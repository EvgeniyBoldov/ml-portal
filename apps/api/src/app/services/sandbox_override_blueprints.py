...
def _agent_limit_fields(prefix: str = "agent_limits") -> List[Dict[str, Any]]:
    return [
        _field("llm_calls_max", "LLM calls", f"{prefix}.llm_calls_max", field_type="integer"),
        _field("tool_calls_max", "Tool calls", f"{prefix}.tool_calls_max", field_type="integer"),
        _field("wall_time_ms_max", "Wall time (ms)", f"{prefix}.wall_time_ms_max", field_type="integer"),
    ]


def _orchestrator_limit_fields(prefix: str = "orchestrator_limits") -> List[Dict[str, Any]]:
    return [
        _field("llm_calls_max", "LLM calls", f"{prefix}.llm_calls_max", field_type="integer"),
        _field("wall_time_ms_max", "Wall time (ms)", f"{prefix}.wall_time_ms_max", field_type="integer"),
    ]
...
def _runtime_limit_fields(prefix: str = "runtime_limits") -> List[Dict[str, Any]]:
    return [
        _field("wall_time_ms_max", "Wall time (ms)", f"{prefix}.wall_time_ms_max", field_type="integer"),
...
SANDBOX_BLUEPRINTS: List[Dict[str, Any]] = [
    _blueprint(
        ...
        [
            ...
            _section("Limits", _agent_limit_fields()),
            _section(
                "Safety",
                [
    ...
    _blueprint(
        ...
        [
            ...
            _section("Limits", _orchestrator_limit_fields()),
        ],
    ),
    _blueprint(
        "tenant",
    ...
    _blueprint(
        ...
        [
            ...
            _section("Limits", _runtime_limit_fields()),
        ],
    ),
    _blueprint(
        "branch_facts",
        ...
        [
            _section(
                "Факты",
                [
                    _field("base", "Base", "base", field_type="json", editable=False),
                    _field("overrides", "Overrides", "overrides", field_type="json", editable=False),
                    _field("effective", "Effective", "effective", field_type="json", editable=False),
                ],
            ),
        ],

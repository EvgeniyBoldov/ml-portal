...
PLANNER_V3: Dict[str, Any] = {
    ...
    "output_requirements": (
        ...
        '  "final_answer": "<готовый ответ пользователю для direct_answer, или канонический answer_brief для final>",\n'
        ...
        "и без гиперссылок. Для kind=direct_answer final_answer можно писать сразу как финальный текст пользователю."
    ),
    "temperature": 0.2,
    "max_tokens": 4096,
    "timeout_s": 60,

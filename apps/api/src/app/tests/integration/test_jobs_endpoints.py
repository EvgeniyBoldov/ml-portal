...
class TestJobsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_jobs_authorized(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_list_jobs_with_pagination(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_list_jobs_with_status_filter(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_list_jobs_invalid_status(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_get_job_by_id_authorized(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_cancel_job_authorized(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_retry_job_authorized(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_job_pagination_cursor(self, async_client: AsyncClient, simple_user_token):
    ...
    @pytest.mark.asyncio
    async def test_job_limit_validation(self, async_client: AsyncClient, simple_user_token):

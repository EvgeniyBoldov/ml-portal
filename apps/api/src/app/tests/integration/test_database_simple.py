"""
Упрощенные интеграционные тесты для базы данных.
...
class TestDatabaseIntegration:
        ...
        try:
            ...
            for user_data in user_data_list:
                task = asyncio.create_task(
                    self._create_user_async(db_session, user_data)
                )
                tasks.append(task)
    ...
    async def _create_user_async(self, db_session: AsyncSession, user_data: dict):

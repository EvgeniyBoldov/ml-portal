    ...
    async def resolve(
        ...
        *,
        ...
        for allowed in instances:
            ...
            logger.debug("preflight_collection_started", extra=collection_log_context)
            ...
            collection_slug = str(collection.slug)
            logger.debug("preflight_collection_stage_started", extra={**collection_log_context, "stage": "status_snapshot"})
            status_snapshot = await self.collection_status_snapshot.get_status_snapshot(collection)
            logger.debug("preflight_collection_stage_completed", extra={**collection_log_context, "stage": "status_snapshot", "duration_ms": int((monotonic() - collection_started) * 1000)})
            ...
            logger.debug("preflight_collection_stage_started", extra={**collection_log_context, "stage": "operation_resolution"})
            ...
            logger.debug("preflight_collection_stage_completed", extra={**collection_log_context, "stage": "operation_resolution", "duration_ms": int((monotonic() - collection_started) * 1000), "operations_count": len(operations)})
            ...
            if not operations:
                ...
                logger.debug("preflight_collection_completed", extra={**collection_log_context, "duration_ms": int((monotonic() - collection_started) * 1000), "operations_count": 0})
                continue
            ...
            logger.debug("preflight_collection_completed", extra={**collection_log_context, "duration_ms": int((monotonic() - collection_started) * 1000), "operations_count": len(operations)})

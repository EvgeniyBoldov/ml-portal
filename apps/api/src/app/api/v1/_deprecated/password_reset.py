...
Password reset functionality should be implemented in routers/security.py under '/auth'.

This module has incorrect imports and hardcoded prefix that breaks the unified routing scheme.
It is NOT mounted in the main router.

...
- [ ] **Credential Strategy Constructor**: Конструктор стратегий на фронте
  - Сейчас: фиксированные стратегии (`user_only`, `tenant_and_default`, `any`)
  - Будущее: UI для создания кастомных стратегий с выбором уровней
  - Формочка с названием стратегии и чекбоксами уровней
  - Примечание: 5 базовых вариантов покрывают 95% кейсов
